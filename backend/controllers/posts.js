...
exports.getAllPosts = (req, res, next) => {
  postsManager.getAllPosts().then((response) => {
...
exports.createPost = (req, res, next) => {
  ...
  postsManager.createPost(sqlInserts).then((response) => {
...
exports.getComments = (req, res, next) => {
  ...
  postsManager.getComments(sqlInserts).then((response) => {
    res.status(200).json(JSON.stringify(response));
  });
};
exports.createComment = (req, res, next) => {
  ...
  postsManager.createComment(sqlInserts).then((response) => {
    res.status(201).json(JSON.stringify(response));
  });
};
...
exports.getAllLikes = (req, res, next) => {
  postsManager.getAllLikes().then((response) => {
    res.status(200).json(JSON.stringify(response));
  });
};
